package com.dzianis.patterns.memento.shapeEditor.editor;
...
import com.dzianis.patterns.memento.shapeEditor.commands.ColorCommand;
import com.dzianis.patterns.memento.shapeEditor.commands.MoveCommand;
    ...
    private void attachMouseListeners() {
        MouseAdapter colorizer = new MouseAdapter() {
            ...
            public void mousePressed(MouseEvent e) {
                ...
                com.dzianis.patterns.memento.shapeEditor.shapes.Shape target = editor.getShapes().getChildAt(e.getX(), e.getY());
                if (target != null) {
