...
import com.dzianis.patterns.GoF.memento.shapeEditor.commands.ColorCommand;
import com.dzianis.patterns.GoF.memento.shapeEditor.commands.MoveCommand;
    ...
    private void attachMouseListeners() {
        MouseAdapter colorizer = new MouseAdapter() {
            ...
            public void mousePressed(MouseEvent e) {
                ...
                com.dzianis.patterns.GoF.memento.shapeEditor.shapes.Shape target = editor.getShapes().getChildAt(e.getX(), e.getY());
                if (target != null) {
